...
//  Project23
//
//  Created by Shawn Bierman on 5/17/19.
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        physicsWorld.gravity = CGVector(dx: 0, dy: -6)  // less than Earth default (-9.8)
        physicsWorld.speed = 0.85                       // all movement slowed
    ...
    func createScore() {
        ...
        score = 0   // trigger property observer
    }
