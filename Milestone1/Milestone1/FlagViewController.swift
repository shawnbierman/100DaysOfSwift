...
class FlagViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let flagName = flags[indexPath.item]
        let flagnamePrefixIndex = flagName.firstIndex(of: "@")!
        cell.textLabel?.text = flagName.prefix(upTo: flagnamePrefixIndex).uppercased()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let vc = storyboard?.instantiateViewController(withIdentifier: "Detail") as? DetailViewController {
            let filenameString = flags[indexPath.row]
            vc.imageFilename = filenameString
            let prefix = filenameString.firstIndex(of: "@")!
            vc.country = filenameString.prefix(upTo: prefix).uppercased()
